...
Pentru elaborarea lucrarii folosesc LaTex (matrita actuala se regaseste mai
jos).
...
Oficiu: 10 puncte. Nimic de facut aici.

Capitole:

- Introducere: 10 puncte, aproximativ o pagina
  - Furnizeaza cititorului suficiente informatii pentru a intelege raportul.
  - Stabileste clar intrebarile de cercetare.
  - Prezinta intrebari de cercetare importante si relevante.
  - Prezinta clar contributia propusa prin raport.
- Setul de date: 15 puncte, cateva paragrafe
  - Setul de date este potrivit pentru a raspunde la intrebarile de cercetare
    (posibil sa fie nevoie de argumentare).
  - Datele continute in setul de date sunt descrise corespunzator.
...
- Concluzia: 5 puncte, 2 paragrafe
  - Cuprinde in format scurt si concis informatiile din lucrare.
  - Concluziile corespund cu intrebarile de cercetare alese si analiza realizata
    sustine aceste concluzii.

Codul sursa: 30 puncte. Aceasta parte e completa deja.

Calitatea scrisului conteaza!

## Lucrare

Aceasta este matrita lucrarii mele pana acum:
...
Vei sugera, pe langa continut, unde sa inserez tabele sau grafice si ce sa
contina acestea. Exemple: descrierea unor date, scatter plot intre doua
variabile, bar plot pentru genres, keywords, si orice altceva crezi ca e de
folos.
